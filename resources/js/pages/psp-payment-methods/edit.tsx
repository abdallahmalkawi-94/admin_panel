...
export default function Edit({
    ...
    const [paymentMethodConfig, setPaymentMethodConfig] =
        useState<PaymentMethodConfig>({
            payment_method_id: pspPaymentMethod.payment_method_id || 0,
            refund_option_id:
                pspPaymentMethod.refund_option_id?.toString() || '',
            payout_model_id: pspPaymentMethod.payout_model_id?.toString() || '',
            support_tokenization:
                pspPaymentMethod.support_tokenization || false,
            subscription_model:
                pspPaymentMethod.subscription_model?.toString() || '1',
            ...
            support_international_payment:
                pspPaymentMethod.support_international_payment || false,
            ...
            max_allowed_amount:
                pspPaymentMethod.max_allowed_amount?.toString() || '0',
            min_allowed_amount:
                pspPaymentMethod.min_allowed_amount?.toString() || '0',
            configPairs: jsonToPairs(
                pspPaymentMethod.config as
                    | Record<string, unknown>
                    | null
                    | undefined,
            ),
            testConfigPairs: jsonToPairs(
                pspPaymentMethod.test_config as
                    | Record<string, unknown>
                    | null
                    | undefined,
            ),
    ...
    const removeConfigPair = (type: 'config' | 'test', index: number) => {
        const pairToRemove =
            type === 'config'
                ? paymentMethodConfig.configPairs[index]
                : paymentMethodConfig.testConfigPairs[index];
        const keyToRemove = pairToRemove.key.trim();

        if (keyToRemove) {
            const newConfigPairs = paymentMethodConfig.configPairs.filter(
                (p) => p.key.trim() !== keyToRemove,
            );
            const newTestConfigPairs =
                paymentMethodConfig.testConfigPairs.filter(
                    (p) => p.key.trim() !== keyToRemove,
                );
            ...
            const newTestConfigPairs =
                paymentMethodConfig.testConfigPairs.filter((_, i) => {
    ...
    const handleSubmit: FormEventHandler = (e) => {
        ...
        const refundOptionId =
            ...
            paymentMethodConfig.refund_option_id !== '' &&
            paymentMethodConfig.refund_option_id !== null
        ...
        const payoutModelId =
            ...
            paymentMethodConfig.payout_model_id !== '' &&
            paymentMethodConfig.payout_model_id !== null
    ...
    const checkoutBadge = paymentMethodConfig.shown_in_checkout
        ? 'success'
        : 'secondary';
                                    ...
                                    <CardContent className="space-y-6">
                                        ...
                                        <div className="grid gap-6 md:grid-cols-3">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <Select
                                                    value={
                                                        paymentMethodConfig.subscription_model
                                                    }
                                                    onValueChange={(value) =>
                                                        updatePaymentMethodConfig(
                                                            'subscription_model',
                                        ...
                                        <div className="grid gap-6 md:grid-cols-3">
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <Input
                                                    ...
                                                    type="number"
                                                    value={
                                                        paymentMethodConfig.min_allowed_amount
                                                    }
                                                    onChange={(e) =>
                                                        updatePaymentMethodConfig(
                                                            'min_allowed_amount',
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <Input
                                                    ...
                                                    type="number"
                                                    value={
                                                        paymentMethodConfig.max_allowed_amount
                                                    }
                                                    onChange={(e) =>
                                                        updatePaymentMethodConfig(
                                                            'max_allowed_amount',
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="flex items-center justify-between">
                                                ...
                                                <Switch
                                                    id="post_fees_to_psp"
                                                    checked={
                                                        paymentMethodConfig.post_fees_to_psp
                                                    }
                                                    onCheckedChange={(
                                                        checked,
                                                    ) =>
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            <div className="rounded-xl border">
                                                <Table>
                                                    ...
                                                    <TableBody>
                                                        {paymentMethodConfig.configPairs.map(
                                                            (
                                                                pair,
                                                                pairIndex,
                                                            ) => (

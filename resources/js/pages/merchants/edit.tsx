...
export default function Edit({
    ...
    const selectedParent = availableParentMerchants.find(
        (parent) => parent.id.toString() === data.parent_merchant_id,
    );
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                Keep the merchant profile consistent and production-ready.
                            </p>
                        </div>
                    ...
                    <Card className="border-emerald-500/20">
                        <CardHeader className="flex flex-row items-start justify-between gap-4 py-6">
                            <div>
                                ...
                                <CardDescription>
                                    Update the core identity and ownership details.
                                </CardDescription>
                            </div>
                    ...
                    <div className="space-y-6 lg:sticky lg:top-6 lg:self-start">
                        <Card className="border-muted/60 bg-muted/30 py-6">
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Quick snapshot of the current configuration.
                                </CardDescription>
                            </CardHeader>

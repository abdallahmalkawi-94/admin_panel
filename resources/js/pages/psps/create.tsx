...
import { RefreshCw, Save, X, Sparkles, Banknote, Link as LinkIcon, ShieldCheck, Split } from 'lucide-react';
                    ...
                    <div className="flex flex-wrap items-center justify-between gap-4">
                        <div>
                            ...
                            <p className="text-muted-foreground">
                                Configure settlement, technical access, and banking flows.
                            </p>
                        </div>
                        ...
                        <Card className="py-6">
                            <CardHeader className="flex flex-row items-start justify-between gap-4">
                                <div>
                                    ...
                                    <CardDescription>
                                        Move through the setup tabs to complete the profile.
                                    </CardDescription>
                                </div>
                        ...
                        <Card className="border-muted/60 bg-muted/30 py-6">
                            ...
                            <CardContent className="space-y-4">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    ...
                                    <Badge variant={data.enable_auto_transfer ? 'success' : 'secondary'}>
                                        {data.enable_auto_transfer ? 'Auto Transfer' : 'Manual Transfer'}
                                    </Badge>
                                </div>
